...
//     { time: '10:42:02', msg: 'Initializing AR environment...', type: 'info' },
//     { time: '10:42:03', msg: 'WARN: Sensor calibration required', type: 'warn' },
//     { time: '10:42:03', msg: 'Tracking real-world surfaces...', type: 'info' },
//     { time: '10:42:04', msg: '3D object rendering initialized', type: 'info' },
//     { time: '10:42:05', msg: 'Spatial mapping completed successfully', type: 'info' },
//   ]);
...
//   //         msg: `AR module deployed successfully: ${Math.random().toString(36).substring(7)}`, 
//   //         type: 'info' 
//   //       }];
//   //       return newLogs;
//   //     });
...
//       <div className="absolute left-6 top-1/2 -translate-y-1/2 hidden xl:flex flex-col gap-4 z-20">
//         {[1,2,3,4,5,6].map((num)=>(
//           <div key={num} className={`w-8 h-8 border flex items-center justify-center text-[10px] mono transition-colors cursor-pointer ${num===1?'border-sky-500 text-sky-500':'border-white/10 text-white/30 hover:border-white/30'}`}>
//             0{num}
//           </div>
//         ))}
//       </div>
...
//           <div className="w-[800px] h-[800px] bg-sky-900/10 rounded-full blur-[120px] opacity-40 animate-[portal-pulse_10s_ease-in-out_infinite]"></div>

//           <div className="absolute w-[300px] h-[300px] portal-ring border-sky-500/20 animate-[ring-rotate_20s_linear_infinite]"></div>
//           <div className="absolute w-[500px] h-[500px] portal-ring border-sky-500/10 animate-[ring-rotate_30s_linear_infinite_reverse]"></div>
//           <div className="absolute w-[700px] h-[700px] portal-ring border-sky-500/5 animate-[ring-rotate_40s_linear_infinite]"></div>

//           <div className="absolute bottom-0 w-[600px] h-[400px] bg-gradient-to-t from-sky-600/20 via-transparent to-transparent blur-[60px] rounded-full"></div>

//           <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[1px] h-[100vh] bg-gradient-to-t from-sky-500 via-sky-500/20 to-transparent shadow-[0_0_20px_rgba(168,85,247,0.5)]"></div>

//           <div className="absolute bottom-[10%] left-1/2 -translate-x-1/2 w-[80vw] h-[1px] bg-gradient-to-r from-transparent via-sky-500/30 to-transparent blur-[2px]"></div>
//         </div>
...
//               REAL-TIME AR ENVIRONMENT TRACKING
//             </li>
//             <li className="flex items-center gap-3">
//               <span className="w-1.5 h-1.5 bg-sky-500"></span>
//               IMMERSIVE 3D OBJECT VISUALIZATION
//             </li>
//             <li className="flex items-center gap-3">
//               <span className="w-1.5 h-1.5 bg-sky-500"></span>
//               AI POWERED SPATIAL INTERACTION
//             </li>
//           </ul>
...
//             <button className="bg-sky-600 hover:bg-sky-500 text-black px-8 py-4 mono text-xs font-bold uppercase tracking-widest flex items-center gap-2 transition-all group">
...
//             <span className="mono text-[8px] text-white/30 uppercase tracking-[0.2em]">
//               IMMERSIVE TECHNOLOGY READY
//             </span>
//             <span className="mono text-[8px] text-white/30 uppercase tracking-[0.2em]">
//               REAL-TIME AUGMENTED INTERACTION
//             </span>
//           </div>
//         </div>
...
//                    </div>
//                  </div>
//                  <div className="relative w-full h-32 bg-gradient-to-t from-sky-500/10 to-transparent rounded"></div>
//               </div>
//             </div>
//           </div>
//         </div>
...
//         <div className="absolute left-6 bottom-16 -rotate-90 mono text-[8px] text-white/20 uppercase tracking-[0.4em]">
//           AR_MODULE_V1
//         </div>
//       </div>
...
//       <div className="absolute left-6 top-1/2 -translate-y-1/2 hidden xl:flex flex-col gap-4 z-20">
//         {[1,2,3,4,5,6].map((num)=>(
//           <div key={num} className="w-8 h-8 border flex items-center justify-center text-[10px] mono">
//             0{num}
//           </div>
//         ))}
//       </div>
...
//             <li>REAL-TIME AR ENVIRONMENT TRACKING</li>
//             <li>IMMERSIVE 3D OBJECT VISUALIZATION</li>
//             <li>AI POWERED SPATIAL INTERACTION</li>
//           </ul>

//           {/* Buttons */}
//           <div className="fixed bottom-5 right-5 z-50 flex rounded-xl overflow-hidden border border-white/20">

//             <button onClick={pauseSound} className="bg-black text-white px-5 py-3">
//               ⏸
//             </button>

//             <button onClick={playSound} className="bg-sky-500 text-black px-5 py-3">
//               ▶
//             </button>
...
//               <div key={i} className="flex gap-4 text-sm">
//                 <span className="text-white/20">{log.time}</span>
//                 <span className={log.type==='warn'?'text-sky-300':'text-white/60'}>
//                   {log.msg}
//                 </span>
//               </div>
//             ))}
...
//   if (audioRef.current) {
//     audioRef.current.pause()
//     audioRef.current.currentTime = 0 // 🔥 IMPORTANT (force stop)
//   }
// }
...
//   const audioRef = useRef<HTMLAudioElement | null>(null) // ✅ ADDED
...
//       {/* 🔘 SMALL CLEAN BUTTON (NOT DISTURBING UI) */}
//       <div className="fixed bottom-5 right-5 z-50 flex rounded overflow-hidden border border-white/20 backdrop-blur-sm">
//         <button
//           onClick={stopSound}
//           className="px-3 py-2 text-white bg-black/70 hover:bg-black"
//         >
//           ⏸
//         </button>
//         <button
//           onClick={playSound}
//           className="px-3 py-2 text-black bg-white hover:bg-gray-200"
//         >
//           ▶
//         </button>
//       </div>
...
//         <button
//           onClick={toggleAudio}
//           className="backdrop-blur-md bg-white/5 border border-white/10 hover:border-purple-500/50 
//           text-white px-4 py-2 rounded-full flex items-center gap-2 transition-all 
//           hover:bg-purple-500/10 shadow-[0_0_20px_rgba(168,85,247,0.2)]"
//         >
//           <span className="text-xs mono tracking-widest">
//             {isPlaying ? "SOUND ON" : "SOUND OFF"}
//           </span>
//           <span className={`w-2 h-2 rounded-full ${isPlaying ? "bg-purple-500 animate-pulse" : "bg-white/30"}`}></span>
//         </button>
//       </div>
...
//               <div className="flex justify-between items-center border-b border-white/5 pb-4">
//                 <span className="mono text-[9px] text-white/40 uppercase tracking-widest font-bold">
...
//             <div className="border border-white/5 p-6 space-y-2 mono text-[9px] h-32 overflow-hidden">
//               {logs.map((log, i) => (
//                 <div key={i} className="flex gap-4">
//                   <span className="text-white/20">{log.time}</span>
//                   <span className={log.type === 'warn' ? 'text-purple-400' : 'text-white/60'}>
...
//               <div className="flex justify-between items-center border-b border-white/5 pb-4">
//                 <span className="mono text-[9px] text-sky-300 uppercase tracking-widest font-bold">
//                   AR VISUALIZATION INTERFACE
//                 </span>
//                 <div className="flex items-center gap-2">
//                   <span className="w-1.5 h-1.5 rounded-full bg-sky-500"></span>
//                   <span className="mono text-[9px] text-sky-300 font-bold">ONLINE</span>
//                 </div>
//               </div>
...
// audio is not getting pause so check it out my code and correct it 
...
//         <div className="absolute bottom-[-20%] left-1/2 -translate-x-1/2 w-full h-full flex items-center justify-center">
//           <div className="w-[800px] h-[800px] bg-purple-900/10 rounded-full blur-[120px] opacity-40"></div>
//         </div>
...
//           <h1 className="text-6xl md:text-8xl font-black tracking-tight text-white uppercase">
//             LEARNAI<br />
//             <span className="text-white/20">COHORT</span>
//           </h1>

//           <ul className="space-y-3 mono text-[10px] uppercase tracking-widest text-white/80">
//             <li>PERSONALIZED LEARNING AGENTS</li>
//             <li>AUTONOMOUS ROADMAP ORCHESTRATION</li>
//             <li>SUB-10MS FEEDBACK EXECUTION</li>
//           </ul>
...
//           {/* buttons etc same */}
//           <div className="fixed bottom-5 right-5 z-50 flex border border-white">
//             <button onClick={pauseSound} className="bg-black text-white px-4 py-2">⏸</button>
//             <button onClick={playSound} className="bg-white text-black px-4 py-2">▶</button>
//           </div>
//         </div>

//         {/* 🔥 RIGHT SIDE EXACT SAME (UNCHANGED) */}
//         <div className="lg:col-span-5 hidden lg:block">
//           <div className="bg-[#050505] border border-white/10 p-1 relative scanline overflow-hidden">
//             <div className="border border-white/5 p-6 space-y-6">
