...
// //     { name: 'Courses', path: '/courses', icon: 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253' },
// //     { name: 'Roadmap', path: '/roadmap', icon: 'M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7' },
// //     { name: 'DSA Lab', path: '/scores', icon: 'M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10' },
// //     { name: 'Chatbot', path: '/chatbot', icon: 'M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z' },
// //     { name: 'Library', path: '/library', icon: 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253' },
// //     { name: 'Voice Agent', path: '/voice-agent', icon: 'M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z' }, { name: 'Mini Projects', path: '/mini-projects', icon: 'M12 20h9' }
// //   ]
...
// //                   key={link.name}
// //                   to={link.path}
// //                   className={`flex items-center gap-2 px-4 py-2 transition-all group relative ${link.special
...
// //                           key={link.name}
// //                           to={link.path}
// //                           className={`flex items-center gap-3 p-3 rounded-xl transition-all group ${location.pathname === link.path
...
// //               <ul className="space-y-4">
// //                 {["Courses", "Roadmap", "DSA Lab", "Chatbot", "Library", "Mini Projects", "Voice Agent"].map((item) => (
// //                   <li key={item}>
...
//               AI powered platform for learning programming, DSA,
//               roadmaps, quizzes and mini projects.
//             </p>
//           </div>

//           {/* MADE BY */}
//           <div>
//             <h4 className="text-white font-bold mb-4">Made By</h4>

//             <ul className="space-y-2 text-white/50">
//               <li>Hammad Ullah Khan</li>
//               <li>Riddhi Kaushik</li>
//               <li>Toheed</li>
//             </ul>
//           </div>
...
//               <li><Link to="/scores">DSA Lab</Link></li>
//               <li><Link to="/chatbot">Chatbot</Link></li>
//               <li><Link to="/library">Library</Link></li>
//               <li><Link to="/mini-projects">Mini Projects</Link></li>
//               <li><Link to="/voice-agent">Voice Agent</Link></li>
//             </ul>
//           </div>
        ...
        <div className="container mx-auto px-6 lg:px-12 py-3">
          ...
          <div className="flex items-center justify-between">
            ...
            <Link to="/" className="flex items-center gap-2 group">
              <span className="text-purple-500 font-black text-xl group-hover:scale-110 transition-transform">
                &lt; &gt;
              </span>
            ...
            <div className="hidden xl:flex items-center gap-1">
              ...
              {navLinks.map((link) => (
                ...
                <Link
                  key={link.name}
                  to={link.path}
                  className={`flex items-center gap-2 px-3 py-2 transition-all group relative ${
                    link.special
                      ? "bg-purple-600/10 border border-purple-500/30 rounded-lg text-purple-400"
                      : "text-white/60 hover:text-white"
                  }`}
                >
                  ...
                  <svg
                    ...
                    className={`h-4 w-4 ${
                      link.special
                        ? "text-purple-500"
                        : "text-white/40 group-hover:text-purple-500"
                    }`}
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  ...
                  {!link.special && (
                    <span className="absolute bottom-0 left-3 right-3 h-px bg-purple-500 scale-x-0 group-hover:scale-x-100 transition-transform origin-left"></span>
                  )}
              ...
              <div className="hidden xl:flex items-center gap-6">
                ...
                {isSignedIn ? (
                  ...
                  <>
                    ...
                    <Link
                      to="/sign-up"
                      className="bg-gradient-to-r from-purple-600 to-fuchsia-600 text-white text-xs font-black uppercase px-6 py-3 rounded-lg shadow-lg hover:scale-105 transition-all"
                    >
                      Sign Up
                    </Link>
                  </>
