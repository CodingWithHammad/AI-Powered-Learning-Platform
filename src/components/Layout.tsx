        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-16 mb-20">
            ...
            <div className="md:col-span-3 space-y-8">
              ...
              <ul className="space-y-4">
                {["Courses", "Roadmap", "Scores", "Chatbot", "Library", "Mini Projects", "Voice Agent"].map((item) => (
                  <li key={item}>
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center text-white">
      ...
      <div className="relative z-10 w-full max-w-5xl p-6">
        ...
        <h1 className=" mt-20 text-7xl font-black uppercase text-center">
             BST <span className="text-sky-500">Visualization</span>
           </h1>

           <p className="text-sky-300 mt-4 uppercase text-sm tracking-widest text-center">
             Best 3D visualizer for Binary Search Trees built with React and Three.js
          </p> 

        <div className=" mt-3 flex gap-3 justify-center mb-6">
        ...
        <div
          ref={mountRef}
          className="w-full h-[500px] rounded-xl overflow-hidden bg-transparent"
        />
